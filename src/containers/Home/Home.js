...
export default function Home(){
    return(
        ...
        <footer className="py-3 my-4" data-bs-theme="dark">
            ...
            <li className="nav-item"><a href="#" class="nav-link px-2 text-body-secondary white_text">Home</a></li>
            <li className="nav-item"><a href="#" class="nav-link px-2 text-body-secondary white_text">Features</a></li>
            <li className="nav-item"><a href="#" class="nav-link px-2 text-body-secondary white_text">Pricing</a></li>
            <li className="nav-item"><a href="#" class="nav-link px-2 text-body-secondary white_text">FAQs</a></li>
            <li className="nav-item"><a href="#" class="nav-link px-2 text-body-secondary white_text">About</a></li>
            </ul>
